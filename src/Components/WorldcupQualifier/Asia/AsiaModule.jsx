...
const AsiaModule = () => {
  ...
  useLayoutEffect(() => {
    axios
      .get(
        `https://apiv3.apifootball.com/?action=get_events&from=${formatDateToYYMMDD()}&to=${formatDateToYYMMDD()}&league_id=22&APIkey=${key}`
      )
      .then((response) => {
  ...
  return (
    <div className="flex flex-col gap-2 m-2">
      {isLoading ? (
        ...
        <div>
          <h1 className="text-2xl font-semibold">Asian Qualifier</h1>
          {matchAvailability ? (
